...
export declare class QueriesExternalStore {
    ...
    readonly queryIbcDepositStatuses: DeepReadonly<ObservableQueryIbcStatuses>;
    constructor(kvStore: KVStore, priceStore: IPriceStore, feeMetricsBaseURL?: string, poolRewardsBaseUrl?: string, ibcStatusBaseUrl?: string);
}
