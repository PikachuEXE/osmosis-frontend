...
export const SourceChain_PrettyNameMap: {
  [id: string]: string;
} = IS_TESTNET ?
  {
  ...
  } :
  {
    ...
    "ethereum": "Ethereum Main Network",
    "fantom": "Fantom Operat",
...
export const SourceChainConfigs: {
  ...
  usdc: {
    ethereum: {
      ...
      prettyName: SourceChain_PrettyNameMap["ethereum"],
    },
    avalanche: {
      ...
      prettyName: SourceChain_PrettyNameMap["avalanche"],
    },
    binance: {
      id: "binance" as const,
      erc20ContractAddress: IS_TESTNET
      ...
      transferFeeMinAmount: IS_TESTNET ? "150000" : "1500000",
      prettyName: SourceChain_PrettyNameMap["binance"],
    },
    fantom: {
      id: "fantom" as const,
      erc20ContractAddress: IS_TESTNET
      ...
      transferFeeMinAmount: IS_TESTNET ? "150000" : "1500000",
      prettyName: SourceChain_PrettyNameMap["fantom"],
    },
    moonbeam: {
      ...
      transferFeeMinAmount: IS_TESTNET ? "150000" : "1500000",
      prettyName: SourceChain_PrettyNameMap["moonbeam"],
    },
    polygon: {
      id: "polygon" as const,
      erc20ContractAddress: IS_TESTNET
      ...
      transferFeeMinAmount: IS_TESTNET ? "150000" : "1500000",
      prettyName: SourceChain_PrettyNameMap["polygon"],
    },
  },
  weth: {
    ethereum: {
